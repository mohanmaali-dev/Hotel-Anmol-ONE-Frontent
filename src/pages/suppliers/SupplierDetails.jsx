...
function SupplierDetails() {
  ...
  return (
    <main className="px-4 py-6 sm:px-6 lg:px-8 lg:py-8"><div className="page-content">
      ...
      <ConfirmDeleteModal open={confirmDelete} title={`Delete ${supplier.name}?`} message="This supplier will be permanently removed. Suppliers with purchase history are protected and cannot be deleted." confirmLabel="Delete Supplier" loading={working} onConfirm={handleDelete} onClose={() => setConfirmDelete(false)} />
    </div></main>
  )
}
