    ...
    <main className="px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      <div className="page-content">
        ...
        <div className="mt-6 space-y-5">
          ...
          <SalesTable sales={sales} total={pagination.total} loading={loading} />
