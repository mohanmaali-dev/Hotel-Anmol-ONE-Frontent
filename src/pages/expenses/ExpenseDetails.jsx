...
function ExpenseDetails() {
  ...
  return (
    <main className="px-4 py-6 sm:px-6 lg:px-8 lg:py-8"><div className="page-content">
      ...
      <ConfirmDeleteModal open={confirmDelete} title={`Delete expense ${expense.expenseNo}?`} message="This expense will be permanently removed from expense records and future reports. This action cannot be undone." confirmLabel="Delete Expense" loading={deleting} onConfirm={handleDelete} onClose={() => setConfirmDelete(false)} />
    </div></main>
  )
}
