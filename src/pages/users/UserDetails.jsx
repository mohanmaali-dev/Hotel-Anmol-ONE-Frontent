...
function UserDetails() {
  ...
  return <main className="px-4 py-6 sm:px-6 lg:px-8 lg:py-8"><div className="page-content">
    ...
    <ConfirmDeleteModal open={confirmDelete} title={`Delete ${user.fullName}?`} message="This user account will be permanently removed. This action cannot be undone." dependencyType="user" recordId={user.id} confirmLabel="Delete User" loading={working} onConfirm={handleDelete} onClose={() => setConfirmDelete(false)} />
  </div></main>
}
